...
const Widget: React.FC<HyphenWidgetOptions & IWidgetProps> = (props) => {
  ...
  return (
    <>
      ...
      <div className="tw-hw-auto tw-hw-bg-white tw-hw-p-6 md:tw-hw-rounded-[25px] md:tw-hw-shadow-[0_24px_50px_rgba(0,0,0,0.25)]">
        {props.tag !== config.constants.DEPOSIT_TAG ? (
          <div className="tw-hw-mb-8 tw-hw-flex tw-hw-items-center tw-hw-justify-between">
        ...
        <div className="tw-hw-grid tw-hw-grid-cols-1 tw-hw-gap-8">
          <NetworkSelectors
        ...
        {showEthereumDisclaimer ? (
          <article className="tw-hw-mt-3 tw-hw-flex tw-hw-h-auto tw-hw-items-center tw-hw-justify-center tw-hw-rounded-[10px] tw-hw-bg-hyphen-warning/25 tw-hw-p-3 tw-hw-text-xxxs tw-hw-font-bold tw-hw-uppercase tw-hw-text-hyphen-warning md:tw-hw-text-xxs">
